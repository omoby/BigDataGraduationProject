...
public class GenerateMockData {
    ...
    public static void main(String[] args) {
        ...
        try {
            String file = "/home/hadoop/docker/graduationlogs/user_visit_action.txt";
         ...
         */
        try {
            String file = "/home/hadoop/docker/graduationlogs/user_info.txt";
            bw = new BufferedWriter(new OutputStreamWriter(
                    new FileOutputStream(file, true)));
        ...
        try {
            String file = "/home/hadoop/docker/graduationlogs/product_info.txt";
            bw = new BufferedWriter(new OutputStreamWriter(
                    new FileOutputStream(file, true)));
