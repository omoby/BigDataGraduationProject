package graduation.java.spark.session;
    ...
    public static void main(String[] args) {
       ...
       // Logger.getLogger("org").setLevel(Level.ERROR);
        ...
        SparkConf conf = new SparkConf()
                ...
                .set("spark.shufffle.memoryFraction","0.3")
                .set("spark.serializer","org.apache.spark.serializer.KryoSerializer") //开启Kryo序列化模式
                .set("spark.shuffle.consolidateFiles","true") //开启map端输出文件合并
                .set("spark.shuffle.file.buffer","64") //设置shuffle 文件缓冲区大小
                .set("spark.reduce.maxSizeInFlight","24")
                //设置reduce端缓冲区大小
                .set("spark.shuffle.io.maxRetries", "60") //设置shuffle尝试拉取数据的最大次数
                .set("spark.shuffle.io.retryWait", "60") //设置shuffle拉取数据的最大时间间隔
