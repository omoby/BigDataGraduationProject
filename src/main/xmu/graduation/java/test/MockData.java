...
import graduation.java.util.StringUtils;
...
public class MockData extends Thread {
    ...
    public static void mock(JavaSparkContext sc, SQLContext sqlContext) {
        ...
        String dates = DateUtils.getTodayDate();
        ...
        for(int i = 0; i < 100; i++) {
            ...
            for(int j = 0; j < 10; j++) {
                ...
                String baseActionTime = dates + " " + random.nextInt(23);
                ...
                for(int k = 0; k < random.nextInt(100); k++) {
                    ...
                    Row row = RowFactory.create(dates, userid, sessionid,
        ...
        StructType schema = DataTypes.createStructType(Arrays.asList(
                DataTypes.createStructField("dates", DataTypes.StringType, true),
    ...
    public void run(JavaSparkContext sc, SQLContext sqlContext) {
        while(true) {
            try {
                int mil = random.nextInt(100);
