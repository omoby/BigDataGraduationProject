...
public class JdbcCRUD {
    ...
    private static void insert(){
        ...
        try {
            ...
            String sql = "insert into test_user(name,age) values('Jack',22)";
    ...
    public static void update(){
        ...
        try{
            ...
            String  sql = "update test_user set age = 25 where name = 'Jack'";
            int rtn = stmt.executeUpdate(sql);
            System.out.println("SQL语句影响了【" +rtn +"】行。");
    ...
    public static void delete(){
        ...
        try{
            ...
            stmt = conn.createStatement();
            String sql = "delete from test_user where name='Jack'";
            int rtn = stmt.executeUpdate(sql);
            System.out.println("SQL语句影响了【" +rtn +"】行。");
